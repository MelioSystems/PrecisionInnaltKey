...
extension NSNotification.Name {
    public static let UserSignIn = Notification.Name("UserSignInNotification")
    public static let UserRegisterIn = Notification.Name("UserRegisterInNotification")
    public static let UserErrIn = Notification.Name("UserErrInNotification")

}

public final class oAuthManager: NSObject, ASAuthorizationControllerPresentationContextProviding, ASAuthorizationControllerDelegate {
    var authenticationAnchor: ASPresentationAnchor?

    public final func signInWith(anchor: ASPresentationAnchor,relyingParty:String,challengeStr:String) {
    ...
    public final func signUpWith(userName: String,relyingParty:String,challengeStr:String, anchor: ASPresentationAnchor) {
        let domain =  relyingParty//"webauth.legalastra.com"
...
//            print("rawClientDataJSON \(rawClientDataJSON.base64EncodedData())")
            ...
            let parameter2 = ["rk":"true"
                ] as NSDictionary
            let parameter3 = ["credProps":parameter2
                ] as NSDictionary
//            let c_data = String()
...
//            }
            ...
            let parameters = [
                "id" :base64Id,
                "response":parameter1,
                "clientExtensionResults": parameter3,
                "type": "public-key",
                ] as NSDictionary
